...
typedef struct functionParameterData {
  ...
  char *generated_code; // Generated code for the parameter

  void (*free)(
      struct functionParameterData *); // Function to free the structure
...
typedef struct functionParameterElement {
  ...
  void (*free)(
      struct functionParameterElement *); // Function to free the structure
  FunctionParameterData *(*eval)(
      struct functionParameterElement *,
      EvalContext *); // Function to evaluate the function parameter
...
typedef LinkedList FunctionParameterList; // Alias for LinkedList to represent a
